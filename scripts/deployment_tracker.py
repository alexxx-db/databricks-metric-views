...
def main():
    ...
    if args.command == 'history':
        ...
        for summary in summaries:
            success_rate = (summary.successful_deployments / summary.total_files * 100) if summary.total_files > 0 else 0
            status = "✅ Success" if summary.failed_deployments == 0 else f"❌ {summary.failed_deployments} failed"
        ...
        if summary.end_time:
            ...
            print(f"✅ Successful: {summary.successful_deployments}/{summary.total_files}")
